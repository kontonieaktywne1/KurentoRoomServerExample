  ...
  public final void handleRequest(Transaction transaction, Request<JsonObject> request)
    ...
    switch (request.getMethod()) {
      ...
      case ProtocolElements.SENDMESSAGE_ROOM_METHOD :
        ...
        break;
      case ProtocolElements.ONPAINTSEND_METHOD :
    	userControl.paintSend(transaction, request, participantRequest);
    	break;
      case ProtocolElements.CUSTOMREQUEST_METHOD :
        userControl.customRequest(transaction, request, participantRequest);
        break;
      case ProtocolElements.RECORD_REQUEST_METHOD :
    	userControl.recordSession(transaction, request, participantRequest);
    	break;
      default :
