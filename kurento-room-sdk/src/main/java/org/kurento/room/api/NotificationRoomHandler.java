...
public interface NotificationRoomHandler extends RoomHandler {
  ...
  void onPaintSend(ParticipantRequest request, String userName, String coordinates, 
		  String windowSize, String brushColor, String brushSize, String brushType,String roomName, 
		  Set<UserParticipant> participants, RoomException error);
  ...
  void onStopSessionRecording(ParticipantRequest participantRequest, String error);

  void onSessionRecording(ParticipantRequest participantRequest, String error);
}
