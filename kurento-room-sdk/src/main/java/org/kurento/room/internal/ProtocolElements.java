...
public class ProtocolElements {
  ...
  public static final String ONPAINTSEND_METHOD = "paintRequest";
  public static final String ONPAINTSEND_ROOM_PARAM = "room";
  public static final String ONPAINTSEND_USER_PARAM = "user";
  public static final String ONPAINTSEND_COORDS_PARAM = "point";
  public static final String ONPAINTSEND_DISPLAY_SIZE_PARAM = "windowSize";
  public static final String ONPAINTSEND_BRUSH_SIZE_PARAM = "size";
  public static final String ONPAINTSEND_BRUSH_COLOR_PARAM = "color";
  public static final String ONPAINTSEND_BRUSH_TYPE_PARAM = "type";

  public static final String CUSTOMREQUEST_METHOD = "customRequest";
  
  public static final String RECORD_REQUEST_METHOD = "recordRequest";
  public static final String RECORD_ROOM_PARAM = "room";
  public static final String RECORD_SESSION_PARAM = "record";
